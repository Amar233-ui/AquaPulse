      ...
      return (
        <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 9 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <button onClick={() => { setSelectedAlertId(null); if (mob) setOpen(false) }} style={{ color: "#475569", background: "none", border: "none", cursor: "pointer", fontSize: 16 }}>✕</button>
          </div>
          ...
          <button
            onClick={() => { setQuartier(selectedAlert.zone); setSelectedAlertId(null); if (mob) setOpen(false) }}
      ...
      return (
        <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 9 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <button onClick={() => { setSelectedFacilityId(null); if (mob) setOpen(false) }} style={{ color: "#475569", background: "none", border: "none", cursor: "pointer", fontSize: 16 }}>✕</button>
          </div>
          <div style={{ background: `${color}0d`, border: `1px solid ${color}33`, borderRadius: 8, padding: "10px 12px" }}>
          ...
          <button
            onClick={() => { setQuartier(selectedFacility.quartier); setSelectedFacilityId(null); if (mob) setOpen(false) }}
            style={{ background: "#22d3ee", color: "#082f49", border: "none", borderRadius: 8, padding: "9px 12px", fontWeight: 700, cursor: "pointer" }}
          >
            Centrer ce quartier
          </button>
    ...
    return (
      <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 9 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <button onClick={() => { if (mob) setOpen(false) }} style={{ color: "#475569", background: "none", border: "none", cursor: "pointer", fontSize: 16 }}>✕</button>
        </div>
  ...
  return (
    <div style={{ fontFamily: "monospace", position: "relative", width: "100%", height: "100%", display: "flex" }}>
      ...
      <div style={{
        ...
        <div className="czb" style={{ width: mob ? 280 : W, height: "100%", overflowY: "auto", opacity: open ? 1 : 0, transition: "opacity .2s" }}>
          {mob && (selectedAlert || selectedFacility || selectedZone) ? <DC /> : <SB />}
        </div>
      </div>
      <div style={{ flex: 1, position: "relative", minWidth: 0 }}>
        <button onClick={() => setOpen((current) => !current)} style={{ position: "absolute", left: 0, top: "50%", transform: "translateY(-50%)", zIndex: 998, width: 22, height: 54, background: "#020817", border: "1px solid rgba(34,211,238,.35)", borderLeft: "none", borderRadius: "0 8px 8px 0", cursor: "pointer", color: "#22d3ee", fontSize: 12, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "3px 0 12px rgba(0,0,0,.5)" }}>{open ? "‹" : "›"}</button>
        {mob && !open && (
          <button onClick={() => setOpen(true)} style={{ position: "absolute", bottom: 88, left: 12, zIndex: 1000, background: "#020817", border: "1px solid rgba(34,211,238,.4)", borderRadius: 12, padding: "9px 14px", color: "#22d3ee", fontSize: 11, fontWeight: 700, cursor: "pointer" }}>💧 Mon eau</button>
        )}
